    ...
    var f = {
            ...
            onerror: function () {
                this.parentNode && this
                    .parentNode
                    .replaceChild(g(this.alt, !1), this)
            },
            parse: function (d, u) {
                ...
                return (
                            ...
                            return o(d, function (d) {
                                ...
                                if (e && b) {
                                    for (f in c = "<img ".concat(
                                        ...
                                        u.hasOwnProperty(f) && 0 !== f.indexOf("on") && -1 === c.indexOf(" " + f + "=") && (
                        ...
                        : function (d, u) {
                            var f,
                                ...
                                l = function d(u, f) {
                                    ...
                                    for (; a--;) 
                                        ...
                                        3 === (e = c.nodeType)
                                            ? f.push(c)
                                            : 1 !== e || "ownerSVGElement" in c || h.test(c.nodeName.toLowerCase()) || d(
                                                c,
                                                f
                                            );
                                    return f
                            ...
                            for (; p--;) {
                                for (
                                    ...
                                    if (
                                        (s = o.index) !== n && b.appendChild(g(t.slice(n, s), !0)),
                                        o = o[0],
                                        i = x(o),
                                        n = s + o.length,
                                        s = u.callback(i, u),
                                        ...
                                        for (
                                            c in (r = new Image).onerror = u.onerror,
                                            r.setAttribute("draggable", "false"),
                                            f = u.attributes(o, i)
                                        ) 
                                            f.hasOwnProperty(c) && 0 !== c.indexOf("on") && !r.hasAttribute(c) && r.setAttribute(
                                                c,
                                                f[c]
                                            );
                    ...
                    attributes: "function" == typeof u.attributes
                        ? u.attributes
                        : r,
                    base: (
                        "string" == typeof u.base
                            ? u
                            : f
                    ).base,
                    ext: u.ext || f.ext,
    ...
    c.wp.emoji = new function () {
        var n,
            ...
            o = 0 < c
                ...
                .indexOf("Trident/7.0");
        function i() {
            return !a.implementation.hasFeature || a
                .implementation
                ...
                e && new e(function (u) {
                    for (var e, t, n, a, r = u.length; r--;) {
                        ...
                        for (; n--;) {
                            ...
                            !a || 1 !== a.nodeType || a.className && "string" == typeof a.className && -1 !== a
                                .className
                                .indexOf("wp-exclude-emoji") || d(a.textContent) && f(a)
                        }
                    }
                }).observe(a.body, {
                    childList: !0,
        ...
        function f(u, e) {
            var t;
            return !l.supports.everything && n && u && (
                ...
                ? (
                    ...
                    t = {
                        ...
                        callback: function (u, e) {
                            ...
                            return !(
                                l.supports.everythingExceptFlag && !/^1f1(?:e[6-9a-f]|f[0-9a-f])-1f1(?:e[6-9a-f]|f[0-9a-f])$/.test(u) && !/^(1f3f3-fe0f-200d-1f308|1f3f4-200d-2620-fe0f)$/.test(u)
